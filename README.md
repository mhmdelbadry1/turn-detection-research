...
2. **Export 300–500 Gulf turns** so a Smart Turn fine-tune can be scoped — do not start training yet.
3. Decide whether **LiveKit Agents 1.6.x** is acceptable (v1-mini is the best pause number, license-locked).
